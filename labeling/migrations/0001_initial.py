# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2019-08-03 03:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv_header', django.contrib.postgres.fields.jsonb.JSONField(default=list)),
            ],
        ),
        migrations.CreateModel(
            name='Table',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('example', django.contrib.postgres.fields.jsonb.JSONField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(0, 'not sure'), (1, 'female'), (2, 'male')], default=0)),
                ('career', models.IntegerField(default=0)),
                ('approval_rate', models.DecimalField(decimal_places=4, default=1, max_digits=5)),
                ('approval_HIT_number', models.IntegerField(default=0)),
